...
Every feature you add must have tests. Your tests should reside in root
``tests`` directory, i.e., do not put your tests in apps or modules.
...
-  Check coverage and make sure everything is covered. Keep in mind that
   having a high coverage does not necessarily mean everything is
   tested.

-  If exposed as an API, your feature should have end-to-end tests as
   well as unit tests.
