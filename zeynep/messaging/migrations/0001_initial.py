    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('messages', models.ManyToManyField(related_name='conversations', to='messaging.Message')),
                ('target', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='targeted_conversations', to=settings.AUTH_USER_MODEL)),
            ],
        ),
